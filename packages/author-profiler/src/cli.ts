...
program
	...
	.action(
		async (nameOrId: string, options: { id?: boolean; json?: boolean }) => {
			try {
...
program
	...
	.action(
		async (nameOrId: string, options: { id?: boolean; depth?: string }) => {
			try {
...
program
	...
	.action(
		async (nameOrId: string, options: { id?: boolean; dryRun?: boolean }) => {
			try {
